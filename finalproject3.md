...
The biggest adjustment from my project 2 to project 3 stemmed from my interviewee who is a nurse. She recommended that I looked into the medical industry, specifically at doctors and nurses. I was shocked when she told me the stories that she had from working in a Surgical Intensive Care Unit. After I started looking into the disciplinary boards for doctors in West Virginia, I realized a couple of things. First, going forward I will always check my doctor's history. A lot of states have an option where you can search for a doctor by name to pull up their files. I realized that so many of the doctors who were disciplined for controlled substance issues did not have their license revoked. Instead, they were put on probation. This opened to door to pill mills, which then lead me to the House Committee investigation looking specifically at West Virginia. If I could do this project again, I would look into the medical industry sooner.I spent a lot of time looking at other variables that ended up not having a relationship with overdose death rates. The most surprising aspect of this project to me was how difficult it was to gather data. Although there is a lot of data avilable, it is spread all over through different websites and in different formats. 
