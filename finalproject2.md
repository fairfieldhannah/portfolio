...
29 states across the United States submit reports to the Center for Disease Control and Prevention's State Unintentional Drug Overdose Reporting System [(SUDOR)](https://www.cdc.gov/drugoverdose/fatal/dashboard/index.html). SUDOR's purpose is to ["present comprehensive information on the characteristics and circumstances surrounding drug overdose deaths to inform prevention and response efforts"](https://www.cdc.gov/drugoverdose/fatal/dashboard/index.html). The data is submitted by states, who pull overdose death statistics from from death certificates, medical examiner/coroner reports, and postmortem toxicology results. 

We can see that Ohio has the highest number of drug overdoses by a signficant amount. To better understand why Ohio has the highest number of overdoses from states that reported to SUDORS, we can see where in Ohio the overdoses are occuring.
